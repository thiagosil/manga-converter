    ...
    var methods = {
        ...
        _draw: function() {
            ...
            if (interval.start > 0 && o.edges > 0) {
                ...
                if (o.edges < interval.start && o.ellipseText) {
                    $panel.append('<li class="ellipse"><a>' + o.ellipseText + '</a></li>');
                }
            }
            ...
            if (interval.end < o.pages && o.edges > 0) {
                if (o.pages - o.edges > interval.end && o.ellipseText) {
                    $panel.append('<li class="ellipse"><a href="#">' + o.ellipseText + '</a></li>');
                }
        ...
        _appendItem: function(pageIndex, opts) {
            ...
            if (pageIndex == o.currentPage || o.disabled) {
                $link = $('<li class="active"><a href="#">' + (options.text) + '</a></li>');
            } else {
                $link = $('<li><a href="#">' + (options.text) + '</li></a>');
                $link.click(function(){
        ...
        _selectPageElements: function(pageIndex) {
          var itemsOnPage = 10;
          for(var i = 0; i < itemsOnPage; i++)
          {
              $('.table > tbody > tr').eq(pageIndex * itemsOnPage + i + 1 ) .show();
          }
        },  

        _selectPage: function(pageIndex) {
          $('.table > tbody > tr').hide();
          methods._selectPageElements.call(this, pageIndex);
